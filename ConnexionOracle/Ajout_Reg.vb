Public Class Ajout_Reg
    ...
    Private Sub Ajout_Reg_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub AjoutReg_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles AjoutReg.Click
        ...
        nom_reg = Insert_Reg.Text()

        'requete
        MyCommand.CommandText = "INSERT INTO REGION (ID_REG,LIB_REG) VALUES(SEQ_REG.NEXTVAL , '" & nom_reg & "')"
